...
description: The Stacks API provides fast, reliable data for the Stacks blockchain via an easy-to-use REST interface.
llm: false
---
...
- **[Clarinet](/tools/clarinet)**: Looking to develop and test smart contracts? Clarinet provides a local development environment for Stacks.
