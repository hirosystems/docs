...
- **[Bitcoin Indexer](/tools/bitcoin-indexer)**: Want to run your own infra? [Set up your own Bitcoin Indexer](/tools/bitcoin-indexer), the indexer that powers the Ordinals API.
