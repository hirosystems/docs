...
With your editor configured, you're ready to start building. [Create your first Clarinet project](/docs/smart-contracts/creating-clarinet-project) to begin writing smart contracts with full IDE support.

The extension works seamlessly with other Hiro tools—use it alongside the [Clarinet CLI](/docs/clarinet) for testing and [Stacks.js](/docs/stacks.js) for frontend integration.