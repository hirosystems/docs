...
- [Use local accounts](/docs/local-development/using-local-accounts) to fund test transactions
- [Build transactions](/docs/local-development/building-transactions) programmatically
- [Unit test with Clarinet JS SDK](/docs/testing-contracts/unit-testing-with-clarinet-js-sdk)

Want to learn more about devnet internals? Check the [Clarinet devnet guide](https://docs.hiro.so/stacks/clarinet/guides/run-a-local-devnet) for advanced configuration options.