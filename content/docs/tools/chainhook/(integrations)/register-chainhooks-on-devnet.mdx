...
description: Learn how to register Chainhooks on devnet using Clarinet for local development and testing.
---

In this quickstart, you'll learn how to automatically register Chainhooks on devnet using Clarinet. This feature streamlines local development by automatically registering your predicate files when you start devnet.
...
<Steps>
  ...
  <Step>
    ...
    ```terminal
    # In another terminal, call your contract
    $ clarinet console
...
:::next-steps
- [Bitcoin scopes](/tools/chainhook/bitcoin-scopes): Explore available event types for Bitcoin
- [Stacks scopes](/tools/chainhook/stacks-scopes): Explore available event types for Stacks
:::