...
:::next-steps
- [Create a Chainhook](/stacks/platform/guides/create-chainhooks): Learn how to create a Chainhook using the Hiro Platform.
- [Stacks scopes](/stacks/chainhook/references/scopes/stacks): Learn how to use additional scopes to scan for specific Stacks blockchain events.
:::
