...
:::next-steps
- [Register Chainhooks on devnet](/stacks/chainhook/guides/register-chainhooks-on-devnet): Learn how to register Chainhooks on devnet.
- [Bitcoin scopes](/stacks/chainhook/references/scopes/bitcoin): Learn how to use scopes to scan for specific Bitcoin blockchain events.
:::