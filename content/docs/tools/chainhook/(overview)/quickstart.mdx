...
:::prerequisites
- For installation instructions, visit the [Chainhook installation guide](/tools/chainhook/index#installation).
:::
...
:::next-steps
- [Design custom predicates](/tools/chainhook/predicate-design/predicate-basics): Learn to create predicates for contract calls, NFT transfers, and more
- [Run Chainhook as a service](/tools/chainhook/chainhook-registration/local-registration): Set up continuous blockchain monitoring with webhook delivery
:::