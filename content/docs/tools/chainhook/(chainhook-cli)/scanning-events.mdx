...
:::next-steps
- [Deploy to service mode](/tools/chainhook/chainhook-cli/service-mode): Run predicates in real-time after testing
- [Configure webhooks](/tools/chainhook/webhook-server/webhook-setup): Set up endpoints for production event delivery
:::