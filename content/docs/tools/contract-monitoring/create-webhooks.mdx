...
description: Learn how to monitor your contract with custom alerts.
---
...
<Steps>
  <Step>
    ...
    You can set up alert monitoring for any contracts on mainnet—your own deployments or any public contracts.
  </Step>
  ...
  <Step>
    ...
    - **Platform alerts**: View in the Hiro Platform dashboard
