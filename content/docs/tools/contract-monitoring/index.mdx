...
:::next-steps
- [Quickstart](/tools/contract-monitoring/overview/quickstart): Learn how to get started with contract monitoring.
- [Core concepts](/tools/contract-monitoring/overview/concepts): Learn about the core concepts of contract monitoring.
:::
