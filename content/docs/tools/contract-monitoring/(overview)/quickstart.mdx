...
<Cards>
  <Card
    ...
    description="Learn about webhook payload structure and data"
  />
  <Card
    href="/tools/contract-monitoring/event-processing/event-filters"
    title="Advanced filtering"
    description="Target specific events with custom filters"
  />
  <Card
    href="/tools/contract-monitoring/platform-features/analytics-dashboard"
    title="Analytics dashboard"
    description="Visualize contract activity and monitor health"
  />
</Cards>
