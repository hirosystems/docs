...
:::next-steps
- [Create your first monitor](/tools/contract-monitoring/monitoring-setup/create-monitor): Learn how to create your first monitor.
- [Understanding payloads](/tools/contract-monitoring/event-processing/webhook-payloads): Learn how to understand webhook payloads.
:::