...
<Cards>
  <Card
    ...
    description="Step-by-step guide to monitor setup"
  />
  <Card
    href="/tools/contract-monitoring/event-processing/webhook-payloads"
    title="Understanding payloads"
    description="Deep dive into webhook data structure"
  />
  <Card
    href="/tools/contract-monitoring/platform-features/analytics-dashboard"
    title="Analytics dashboard"
    description="Visualize contract activity and trends"
  />
</Cards>