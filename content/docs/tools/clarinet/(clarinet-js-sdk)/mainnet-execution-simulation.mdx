...
<Cards>
  <NextCard 
    href="/tools/clarinet/pyth-oracle-integration"
    title="Pyth oracle integration"
    description="Learn how to integrate the Pyth oracle with your Clarinet project."
  />
  <NextCard 
    href="/tools/clarinet/sbtc-integration"
    title="sBTC integration"
    description="Learn how to integrate the sBTC with your Clarinet project."
  />
</Cards>