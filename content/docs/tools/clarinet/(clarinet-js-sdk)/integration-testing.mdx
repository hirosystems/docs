...
<Cards>
  <NextCard 
    ...
    title="SDK reference"
    description="Learn more about the Clarinet JS SDK."
  />
  <NextCard 
    href="/tools/clarinet/stacks-js-integration"
    title="Stacks.js integration"
    description="Learn how to integrate Stacks.js with your Clarinet project."
  />
</Cards>