...
import { Cards, SecondaryCard } from '@/components/card';
import { Clarinet, Js } from '@/components/ui/icon';
import { File, Folder, Files } from 'fumadocs-ui/components/files';
import { Steps, Step } from 'fumadocs-ui/components/steps';

In this quickstart, you'll build a simple counter smart contract to learn the fundamentals of Clarity development. We'll walk through creating a new project, writing contract code, and testing it in a local environment—all in under 5 minutes.

<Callout type="tip" title="Prerequisites">
Make sure you have Clarinet installed on your system. If not, follow the [installation instructions](/tools/clarinet#installation) to get set up.
</Callout>
...
<Cards>
  <SecondaryCard
    icon={<Clarinet />}
    href="/tools/clarinet/concepts"
    title="Understanding Clarity"
    description="Learn how Clarity contracts work"
  />
  <SecondaryCard
    icon={<Js />}
    href="/tools/clarinet/writing-unit-tests"
    title="Write unit tests"
    description="Test your contract with the Clarinet JS SDK"
  />
  <SecondaryCard
    icon={<Clarinet />}
    href="/tools/clarinet/running-devnet"
    title="Deploy to devnet"
    description="Run a local blockchain for testing"
  />
</Cards>