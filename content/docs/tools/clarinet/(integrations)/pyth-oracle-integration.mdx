---
title: Testing Pyth oracle contracts
sidebarTitle: Pyth oracle testing
...
<div className="space-y-3 my-6">
  <div className="flex items-start gap-3">
    ...
    <span>Setting up mainnet contract dependencies</span>
  </div>
  <div className="flex items-start gap-3">
    <ArrowRight className="h-4 w-4 text-brand-orange mt-1.5 flex-shrink-0" />
    <span>Using mainnet transaction execution (MXS) for oracle testing</span>
  </div>
  <div className="flex items-start gap-3">
    <ArrowRight className="h-4 w-4 text-brand-orange mt-1.5 flex-shrink-0" />
    <span>Creating mock price feeds for unit tests</span>
  </div>
  <div className="flex items-start gap-3">
    <ArrowRight className="h-4 w-4 text-brand-orange mt-1.5 flex-shrink-0" />
    <span>Writing integration tests with real oracle data</span>
  </div>
</div>
...
<div className="space-y-3 my-6">
  <div className="flex items-start gap-3">
    ...
    <span>Clarinet version 2.1.0 or higher with MXS support</span>
  </div>
  <div className="flex items-start gap-3">
    <div className="h-4 w-4 mt-1.5 flex-shrink-0 rounded border-2 border-brand-orange bg-brand-orange flex items-center justify-center">
      <Check className="h-3 w-3 text-white" />
...
<Cards>
  <Card
    ...
    description="Learn how to write oracle-integrated smart contracts"
  />
  <Card
    href="/reference/stacks.js/integrations/pyth-oracle-integration"
    title="Frontend integration"
    description="Build UIs that interact with oracle contracts"
  />
  <Card
    href="/tools/clarinet/clarinet-js-sdk/mainnet-execution-simulation"
    title="Mainnet simulation"
    description="Learn more about testing with mainnet state"
  />
</Cards>