...
<Callout type="tip" title="API rate limits">
...
<Callout type="info" title="Console commands">
...
- Learn about [testing and validation](/tools/clarinet/testing-validation) to write automated tests
- Explore [deployment options](/tools/clarinet/deployment) for moving to testnet
- Check the [CLI reference](/tools/clarinet/cli-reference#clarinet-console) for all console options