...
- Learn to [interact with your contracts](/tools/clarinet/contract-interaction) using the console
- Write [comprehensive tests](/tools/clarinet/testing-validation) for your contracts
- Prepare for [deployment](/tools/clarinet/deployment) to testnet and mainnet