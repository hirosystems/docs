...
:::next-steps
- [Configure the indexer](/tools/bitcoin-indexer/run-indexer/configuration): Fine-tune settings for your use case
- [Start using APIs](/tools/bitcoin-indexer/metaprotocol-apis/ordinals-api): Query your indexed data
:::