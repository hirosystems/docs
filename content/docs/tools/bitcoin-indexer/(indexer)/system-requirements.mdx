...
:::next-steps
- [Full sync](/tools/bitcoin-indexer/run-indexer/full-sync): Start indexing from genesis block
- [Archive bootstrap](/tools/bitcoin-indexer/run-indexer/archive-bootstrap): Quick start using Hiro archives
:::