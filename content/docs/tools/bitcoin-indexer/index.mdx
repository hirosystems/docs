...
<Cards>
  <Card
    href="/tools/bitcoin-indexer/overview/quickstart"
    title="Quickstart"
    description="Set up your indexer using Hiro archives in 30 minutes"
  />
  <Card
    href="/tools/bitcoin-indexer/overview/concepts"
    title="Core concepts"
    description="Understand metaprotocols, reorgs, and indexing architecture"
  />
  <Card
    href="/tools/bitcoin-indexer/run-indexer/system-requirements"
    title="Detailed setup"
    description="Complete guide to production deployment"
  />
</Cards>

<Callout title="Need help with the Bitcoin Indexer?" type="help">
