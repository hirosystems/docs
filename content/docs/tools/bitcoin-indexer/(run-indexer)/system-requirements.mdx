...
<Callout type="info" title="Storage planning">
...
<Callout type="warn" title="txindex requirement">
...
<Cards>
  <NextCard
    ...
    title="Full sync"
    description="Start indexing from genesis block"
  />
  <NextCard
    href="/tools/bitcoin-indexer/run-indexer/archive-bootstrap"
    title="Archive bootstrap"
    description="Quick start using Hiro archives"
  />
</Cards>