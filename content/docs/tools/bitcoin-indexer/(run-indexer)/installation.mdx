...
:::next-steps
- [Configure the indexer](/tools/bitcoin-indexer/run-indexer/configuration): Set up bitcoin-indexer-config.toml
- [Bootstrap from archives](/tools/bitcoin-indexer/run-indexer/archive-bootstrap): Speed up initial sync with pre-indexed data
:::