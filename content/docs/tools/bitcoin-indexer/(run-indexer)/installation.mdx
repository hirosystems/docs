...
- A fully synced Bitcoin node (see [Bitcoin node setup](/tools/bitcoin-indexer/run-indexer/bitcoin-node-setup))
...
<Callout type="info" title="Build time">
...
<Cards>
  <Card
    ...
    description="Set up bitcoin-indexer-config.toml"
  />
  <Card
