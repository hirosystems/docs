...
:::next-steps
- [Use the Ordinals API](/tools/bitcoin-indexer/metaprotocol-apis/ordinals-api): Query inscriptions and digital artifacts
- [Use the Runes API](/tools/bitcoin-indexer/metaprotocol-apis/runes-api): Access Runes token data
:::