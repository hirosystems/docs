...
<Callout type="info" title="Initial sync time">
...
<Cards>
  <NextCard
    ...
    description="Set up the Bitcoin Indexer to connect to your node"
  />
  <NextCard
    href="/tools/bitcoin-indexer/run-indexer/archive-bootstrap"
    title="Bootstrap from archive"
    description="Skip the wait with pre-synced archives"
  />
</Cards>