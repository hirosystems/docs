...
:::objectives
* Configura un proyecto Expo configurado para Stacks.js
* Instalar y configurar los polyfills necesarios para React Native
* Generar carteras y firmar transacciones en una aplicación móvil
* Maneja las limitaciones del entorno JavaScript de React Native
* Construye una aplicación móvil funcional de Stacks
:::

:::prerequisites
* Node.js y npm instalados en tu máquina de desarrollo
* Conocimientos básicos de React Native y Expo
* Familiaridad con los conceptos de Stacks.js
* Dispositivo/simulador iOS o Android para pruebas
:::

## Configura el proyecto de Expo

Comienza creando un nuevo proyecto de Expo. La última versión de Expo proporciona la mejor compatibilidad con los polyfills de Stacks.js.
...
El proyecto de plantilla incluye todo lo necesario para comenzar a construir. Prueba la configuración inicial ejecutando el servidor de desarrollo.

```terminal
$ npm start
```

Conecta tu dispositivo móvil usando la aplicación Expo Go y escanea el código QR para verificar que el proyecto base funciona correctamente.

## Instalar las dependencias necesarias

El entorno JavaScript de React Native carece de ciertas APIs de Node.js y del navegador que Stacks.js requiere. Instala las bibliotecas principales de Stacks junto con los polyfills necesarios.

```terminal
$ npm install @stacks/transactions @stacks/wallet-sdk
```

Instala las dependencias del polyfill como dependencias de desarrollo para manejar las APIs faltantes.
...
El empaquetador Metro necesita configuración para resolver correctamente los módulos de Node.js. Crea un archivo de configuración personalizado de Metro.

```terminal
$ npx expo customize metro.config.js
```

Actualiza la configuración para mapear los módulos de Node.js a sus versiones compatibles con React Native.
...
Crea un sistema de polyfill para hacer que las APIs del navegador y de Node.js estén disponibles en React Native. Esto requiere modificar el punto de entrada de la aplicación.

### Crear el archivo polyfill

Crea un nuevo archivo para inicializar todos los objetos globales requeridos.
...
Crea un nuevo punto de entrada que cargue polyfills antes de que la aplicación se inicie.
...
Con el entorno configurado, ahora puede usar Stacks.js en sus componentes de React Native. Actualice la pantalla principal para demostrar la generación de billeteras y la firma de transacciones.

### Importar módulos de Stacks.js

Edita el componente de la pantalla principal para importar las funciones necesarias de Stacks.js.
...
Crea variables de estado para gestionar los datos de la cartera y la retroalimentación del usuario.
...
Implementa la funcionalidad principal para crear una cartera y firmar una transacción.
...
Crea una interfaz de usuario simple para mostrar información de la cartera y activar la generación de carteras.
...
Ejecuta tu aplicación para verificar que todo funcione correctamente.
...
Para aplicaciones de producción, nunca muestres frases semilla directamente. Implementa almacenamiento seguro utilizando bibliotecas como `react-native-keychain` o `expo-secure-store`.
:::

## Pruébalo

Amplía la implementación básica con características adicionales.
