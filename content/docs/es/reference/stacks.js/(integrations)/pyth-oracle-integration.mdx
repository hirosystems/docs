...
<Steps>
  <Step>
    ...
    El paquete buffer es necesario para la conversión de formatos de datos en entornos de navegador.
  </Step>
  ...
  <Step>
    ...
    Crea una transacción que incluya datos de precios actualizados:
  ...
  <Step>
    ...
    Las actualizaciones del oráculo Pyth requieren una pequeña tarifa. Incluye post-condiciones al llamar a contratos:
...
* [Probando con Clarinet](/tools/clarinet/pyth-oracle-integration): Aprende cómo probar la integración del oráculo Pyth con Clarinet.
:::
