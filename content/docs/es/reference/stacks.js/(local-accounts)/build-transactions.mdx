...
description: Aprende cómo construir transacciones programáticamente para tener control total sobre las interacciones con la blockchain.
---
:::objectives
...
Crea transacciones sin firmar para flujos de trabajo de firma múltiple o firma fuera de línea.
...
Permite que una cuenta pague las tarifas de la transacción de otra cuenta.
...
Usa el `Cl` ayudante para argumentos de contrato con seguridad de tipos.
...
Obtenga estimaciones precisas de las tarifas antes de transmitir.
...
* [Postcondiciones](/reference/stacks.js/post-conditions): Entendiendo las post-condiciones.
:::
