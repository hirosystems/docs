...
description: Crear y activar chainhooks usando el SDK de Chainhooks
---
Crea una nueva configuración de chainhook. Por defecto, los nuevos chainhooks se crean en un estado deshabilitado a menos que `enable_on_registration` está configurado en `true`.
...
Habilita o deshabilita múltiples chainhooks a la vez usando filtros. Esto es útil para gestionar muchos chainhooks programáticamente.
...
Utiliza múltiples filtros juntos:
...
:::next-steps
* [Evaluar](/tools/chainhooks/evaluate): Prueba chainhooks contra bloques pasados
