---
title: Probando contra datos de la red principal
sidebarTitle: Simulación de ejecución de la red principal
description: La Simulación de Ejecución de Mainnet (MXS) te permite probar tus contratos inteligentes de Clarity utilizando datos y estados reales de la mainnet de Stacks. Esta poderosa característica ayuda a asegurar que tus contratos se comporten como se espera en un entorno en vivo.
---
:::objectives
...
* Probando contratos exclusivos de mainnet como protocolos DEX
...
Aunque MXS funciona sin una clave de API, es posible que encuentres límites de velocidad. Configura una clave de API para un acceso confiable:
...
| Resultados inconsistentes | Solucionar `initial_height` en configuración |
| Función no encontrada | Verifique que el contrato exista en su altura de bloque |

## Probando en el área de juegos

Experimenta rápidamente con MXS sin configurar un proyecto:
...
* [Integración de sBTC](/tools/clarinet/sbtc-integration): Aprende cómo integrar el sBTC con tu proyecto de Clarinet.
:::
