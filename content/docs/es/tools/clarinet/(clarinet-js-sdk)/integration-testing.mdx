...
description: Las pruebas de integración son un paso crucial en el desarrollo de contratos inteligentes que implica probar cómo funcionan juntos los diferentes componentes de tu sistema. El SDK de Clarinet JS proporciona herramientas poderosas para escribir y ejecutar pruebas de integración, permitiéndote simular escenarios complejos e interacciones entre múltiples contratos.
---
...
Usaremos un contrato DeFi mejorado que admite tanto depósitos como préstamos. Crea el contrato:
...
En esta prueba de integración, estamos simulando un escenario donde un usuario deposita STX en el contrato DeFi y luego pide prestado contra ese depósito. Analicemos los aspectos clave:

* **`callPublicFn`** - Simula la llamada a funciones públicas tal como en la blockchain real
...
* **Matchers personalizados** - `toBeOk()` y `toBeErr()` validar tipos de respuesta de Clarity

## Pruébalo

Ejecuta tus pruebas de integración:
...
| Aserciones complejas | Desglosar en pruebas más pequeñas y enfocadas |
