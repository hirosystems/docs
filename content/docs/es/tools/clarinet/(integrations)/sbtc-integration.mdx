...
:::objectives
* Agregar contratos inteligentes sBTC a su proyecto Clarinet
...
<Steps>
  ...
  <Step>
    ### Implementar en testnet

    En la red de pruebas, Clarinet automáticamente reasigna a los contratos oficiales de sBTC de Hiro:
...
El clarinete maneja el mapeo de direcciones de contratos sBTC a través de las redes:
...
El contrato del token sBTC permite que la dirección del implementador (multifirma) acuñe tokens. Utiliza este enfoque en tus pruebas:
...
Cuando se utiliza la simulación de ejecución de la red principal, se puede acuñar sBTC utilizando la multifirma real de la red principal:
