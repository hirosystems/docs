...
* Utilizar la ejecución de transacciones de la red principal (MXS) para pruebas de oráculos
* Crear feeds de precios simulados para pruebas unitarias
* Escribir pruebas de integración con datos reales de oracle
:::

:::prerequisites
* Clarinete versión 2.1.0 o superior con soporte MXS
...
<Steps>
  <Step>
    ...
    Agrega los contratos del oráculo Pyth a tus requisitos de Clarinet.toml:
  ...
  <Step>
    ...
    Para pruebas unitarias rápidas, crea un contrato de oráculo simulado:
  ...
  <Step>
    ...
    Para pruebas de integración con datos reales de oracle, utilice la ejecución de transacciones en mainnet:
...
Crea funciones auxiliares para probar varias condiciones del mercado:
...
Crea pruebas de implementación para garantizar una configuración adecuada:
...
Configura GitHub Actions para pruebas automatizadas:
