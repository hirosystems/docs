...
* Desplegar contratos de forma programática
:::
...
<Steps>
  <Step>
    ...
    Agrega los paquetes necesarios de Stacks.js a tu proyecto frontend:
  ...
  <Step>
    ...
    Crea una transferencia simple de STX entre cuentas de devnet:
  ...
  <Step>
    ...
    Interactúa con contratos desplegados en devnet:
  ...
  <Step>
    ...
    Despliegue nuevos contratos en devnet de forma programática:
...
Monitorea cuándo se confirman las transacciones en devnet:
