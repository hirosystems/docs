...
* Se requiere Node.js versión 16 o superior. Compruebe con `node --version`.
:::
...
<Steps>
  ...
  <Step>
    ...
    Busca la confirmación de registro:
  ...
  <Step>
    ...
    Cuando ocurran acciones de contrato, verás los disparadores de Chainhook en la terminal:
    ...
    Verifica la carga útil basada en tu `then_that` configuración:

    * **`http_post`** - Verifica que tu endpoint recibió la solicitud POST
...
Monitorear cuándo se despliegan contratos específicos:
