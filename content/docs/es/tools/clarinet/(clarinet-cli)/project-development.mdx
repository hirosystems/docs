...
Limpie los contratos no utilizados con el `rm` comando:
...
Valida la configuración completa de tu proyecto:
...
Verifique contratos específicos:
...
Clarinet incluye un potente formateador de código para mantener un estilo consistente en todo tu proyecto:
...
| `--tabs` | Usa tabulaciones en lugar de espacios | `clarinet format --tabs` |
...
Ahora puedes implementar traits de contratos de la red principal:
