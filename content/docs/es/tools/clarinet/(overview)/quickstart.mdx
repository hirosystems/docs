...
:::objectives
* Crear un proyecto de contrato inteligente Clarity
...
:::prerequisites
* Clarinete instalado en su máquina. Siga el [guía de instalación](/tools/clarinet#installation) si es necesario.
...
<Steps>
  <Step>
    ...
    Clarinete crea una estructura de proyecto completa para ti. Cada carpeta cumple un propósito específico en tu flujo de trabajo de desarrollo:
  ...
  <Step>
    ...
    Antes de poder probar nuestro contrato, asegurémonos de que sea sintácticamente correcto y seguro en cuanto a tipos. El comando check de Clarinet analiza su contrato sin desplegarlo:
