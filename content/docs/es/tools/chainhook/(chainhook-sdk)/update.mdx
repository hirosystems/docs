...
---
Modifica chainhooks existentes incluyendo filtros, acciones y opciones. La interfaz de usuario de la Plataforma no soporta edición - usa el SDK en su lugar.

:::callout
La interfaz de la plataforma no admite actualmente la edición de chainhooks. Debes usar el SDK o API para realizar actualizaciones.
:::
...
:::next-steps
* [Obtener chainhooks](/tools/chainhook/fetch): Recuperar información de chainhook antes de actualizar
