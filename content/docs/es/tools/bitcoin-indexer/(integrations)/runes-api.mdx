...
sidebarTitle: Integración de la API de Runas
description: Puntos finales de la API REST para consultar grabados de Runas
---
## Visión general

La API de Runas proporciona acceso completo a datos de inscripciones, artefactos digitales y seguimiento de satoshis. Todos los puntos de acceso devuelven JSON y admiten paginación para conjuntos de resultados grandes.
