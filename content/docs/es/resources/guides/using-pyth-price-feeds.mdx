...
* Convirtiendo entre cantidades de USD y criptomonedas
...
<Accordion type="single" collapsible>
  <AccordionItem value="errores de vaa">
    ...
    <AccordionContent>
      Asegúrate de obtener datos VAA con `binary: true` opción y convirtiendo correctamente de base64 a hexadecimal. El VAA debe ser reciente (normalmente dentro de los 5 minutos).
    </AccordionContent>
  </AccordionItem>
