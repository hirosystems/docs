...
Esta guía completa le explica paso a paso cómo integrar [Red Pyth](https://pyth.network)'s oráculo descentralizado para datos de precios en tiempo real en sus aplicaciones de Stacks. Construiremos un ejemplo completo: un NFT que solo se puede acuñar pagando exactamente $100 en sBTC.

:::callout
La integración del protocolo Pyth está disponible como versión Beta en las redes de testnet y mainnet. Es mantenida por Trust Machines y proporciona acceso a feeds de precios en tiempo real para BTC, STX, ETH y USDC.
:::

## Descripción general de la arquitectura

Pyth Network utiliza una única **basado en pull** diseño de oracle:
...
<Steps>
  ...
  <Step>
    ...
    Luego cree un componente React para acuñar:
    ...
    Para obtener detalles completos sobre la integración frontend, consulte nuestra [Guía de integración de Stacks.js](/reference/stacks.js/pyth-oracle-integration).
  </Step>
  ...
  <Step>
    ...
    Para estrategias de prueba avanzadas, incluyendo simulación de mainnet, consulte nuestra [Guía de pruebas de clarinete](/tools/clarinet/pyth-oracle-integration).
  </Step>
</Steps>
...
Agrupar múltiples actualizaciones de precios cuando sea posible:
...
<Accordion type="single" collapsible>
  <AccordionItem value="errores-vaa">
    ...
    <AccordionContent>
      Asegúrate de obtener datos VAA con `binary: true` opción y convirtiendo correctamente de base64 a hexadecimal. El VAA debe ser reciente (típicamente dentro de los 5 minutos).
    </AccordionContent>
  </AccordionItem>
  ...
  <AccordionItem value="problemas-de-gas">
    ...
    <AccordionContent>
      Las actualizaciones de oráculos pueden consumir mucho gas. Asegúrese de que sus límites de gas tengan en cuenta tanto la actualización del oráculo como la lógica de su contrato. Considere almacenar en caché los precios cuando múltiples operaciones necesiten el mismo precio.
    </AccordionContent>
  </AccordionItem>
</Accordion>
...
1. **Manipulación de precios**: Utilice siempre intervalos de confianza e implemente controles de cordura
2. **Front-running**: Considere utilizar esquemas de compromiso-revelación para operaciones sensibles al precio
...
|---------|----------|---------|
| Red principal | pyth-oracle-v3 | `SP3R4F6C1J3JQWWCVZ3S7FRRYPMYG6ZW6RZK31FXY.pyth-oracle-v3` |
