...
description: Instala Docker para ejecutar una devnet local.
---
...
<Tabs id="docker" items={['macOS', 'Windows']}>
  <Tab value="macOS">
    ...
    Para verificar la instalación, ejecute `docker --version` en tu terminal. Deberías ver la información de la versión de Docker.
  </Tab>
  ...
  <Tab value="Windows">
    ...
    4. Siga los pasos del asistente de instalación (es posible que necesite reiniciar su computadora).
    5. Asegúrese de que el backend WSL 2 (Subsistema de Windows para Linux) esté marcado durante la instalación, si corresponde.
    ...
    Es posible que necesites instalar componentes adicionales de Windows como Hyper-V o WSL 2.
    :::
  </Tab>
</Tabs>
