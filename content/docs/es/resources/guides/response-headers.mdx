...
Al llamar a los endpoints relacionados con Bitcoin, recibirás:
...
|:-------------|:-------------|:---------|
| Bitcoin | `/ordinals/*` | Puntos finales del servicio de Bitcoin |
| Bitcoin | `/runes/*` | Puntos finales del servicio de Bitcoin |
