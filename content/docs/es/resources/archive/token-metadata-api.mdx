---
title: Utilice el archivo de la API de metadatos de tokens
description: Descubre cómo utilizar el Archivo Hiro para crear una API de Metadatos de Tokens.
---
## Requisitos previos

Dado que la API de metadatos de tokens depende de una API de blockchain de Stacks, primero deberá lanzar una API de blockchain de Stacks configurada para la misma red de Stacks.
