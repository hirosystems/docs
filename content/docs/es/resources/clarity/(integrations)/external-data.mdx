...
* Construye contratos inteligentes denominados en USD
:::
...
Pyth Network utiliza una **basado en extracción** modelo de oráculo, diferente de los oráculos tradicionales basados en push:
...
|--------|------------------------|------------------------|
| BTC/USD | `0xe62df6c8b4a85fe1a67db44dc12de5db330f7ac66b72dc658afedf0f4a415b43` | [Vista](https://www.pyth.network/price-feeds/crypto-btc-usd) |
| STX/USD | `0xec7a775f46379b5e943c3526b1c8d54cd49749176b0b98e02dde68d1bd335c17` | [Vista](https://www.pyth.network/price-feeds/crypto-stx-usd) |
| ETH/USD | `0xff61491a931112ddf1bd8147cd1b641375f79f5825126d665480874634fd0ace` | [Vista](https://www.pyth.network/price-feeds/crypto-eth-usd) |
| USDC/USD | `0xeaa020c61cc479712813461ce153894a96a6c00b21ed0cfc2798d1f9a9e9c94a` | [Vista](https://www.pyth.network/price-feeds/crypto-usdc-usd) |

## Inicio rápido

<Steps>
  <Step>
    ### Configurar referencias de contrato

    El oráculo Pyth en Stacks consta de varios contratos. Agrega estas referencias a tu contrato:
...
### Protección contra precios obsoletos

Asegúrate de que los datos de precios sean lo suficientemente recientes para tu caso de uso:
...
Para el desarrollo en testnet, utiliza estas direcciones de contrato:
...
* [Probando con Clarinet](/tools/clarinet/pyth-oracle-integration): Configurar pruebas para contratos que dependen de datos de oráculos
:::
