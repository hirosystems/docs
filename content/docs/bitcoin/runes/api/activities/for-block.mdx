...
<Property required={true} deprecated={false} name={"block"} type={"string"}>

Value can represent a Block Height or Block Hash.
...
```bash title="curl"
curl -X GET "https://api.hiro.so/runes/v1/blocks/777678/activity"
```
