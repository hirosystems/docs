...
Check out the [Ordhook as a service](/bitcoin/ordhook/guides/ordhook-as-a-service) for a more advanced use case.

---

### Prerequisites

Before starting, ensure you have `ordhook` installed. If you haven't already, check out the [installation](/bitcoin/ordhook/installation) guide.
...
<Cards className='sm:grid-cols-1'>
  <SmallCard
    ...
    href="/bitcoin/ordhook/guides/ordhook-as-a-service"
