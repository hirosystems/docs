...
- Take advantage of [devnet](stacks/platform/guides/devnet), a private blockchain environment, to test your code.
- Create custom event streams for Stacks or Bitcoin with [Chainhook](stacks/platform/guides/create-chainhooks) on the Platform.
