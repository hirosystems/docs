...
description: This article walks you through the deployment process of your project. Once you have your clarity contracts ready for your project, you can deploy the project easily using the Hiro Platform.
---

## Prerequisites

- Follow the [getting started](platform/getting-started) guide to sign in to the Hiro Platform.
...
- Follow the [build contract](build-contracts) guide to create or customize your smart contracts before you can deploy them.
