...
![Open editor](../images/empty-contract.png)
...
3. Expand _NEW-PROJECT_ and see a directory _contracts_. There should be no contracts in this folder yet.
4. Right-click the _contracts_ folder, select _New file_, and add a new contract with a name of your choice. Eg: _counter.clar_
...
<Callout title="Requirements" type="info">
  **Clarinet integrate** and **deployment plans** are currently not supported in
