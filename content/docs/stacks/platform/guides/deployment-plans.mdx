...
To learn more about Deployment plans, refer to [customize deployment](../../clarinet/guides/create-deployment-plans) within the Clarinet docs.
...
- Now, in your list of contracts, you will see the status of your deployment as `In mempool.`
  ...
  <Callout title="Note" type="info">
    The deployment process may take a while based on the blockchain traffic at
...
If you want to create or update a new contract, refer to this [guide](build-contracts). You can also use the "Open Editor" button to open Visual Studio code to add a new contract.
...
- [Debug contract](../../clarinet/guides/debug-a-contract)
- [Test contract](../../clarinet/guides/testing-with-clarinet-sdk)
- [Customize deployment](../../clarinet/guides/create-deployment-plans)
