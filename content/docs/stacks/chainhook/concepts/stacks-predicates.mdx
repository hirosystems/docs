...
The `asset_identifier` argument admits an asset identifier to observe, ie. `ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.cbtc-sip10::cbtc`.
...
The `asset-identifier` argument is mandatory and requires a string type that fully qualifies the asset identifier to observe, ie: `ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.monkey-sip09::monkeys`.
...
The `contract-identifier` is a mandatory argument that requires a string type, fully qualifying the contract to observe, ie. `ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.monkey-sip09`.
...
The `deployer` argument is mandatory and accepts a string representing a valid STX address, ie. `"ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG"`.
