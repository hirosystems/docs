...
<Tabs defaultValue="op_return">
  ...
  <Accordions>
    <Accordion title="Parameters">
      <Property required={true} deprecated={false} name="equals" type="string/base32hex">
        The `equals` property specifies the exact characters of the string or 32 byte encoded hex to match.
      </Property>
      <Property required={true} deprecated={false} name="starts_with" type="string/base32hex">
        The `starts_with` property specifies the starting characters of the string or 32 byte encoded hex to match.
      </Property>
      <Property required={true} deprecated={false} name="ends_with" type="string/base32hex">
