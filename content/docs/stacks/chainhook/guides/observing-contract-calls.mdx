...
<Callout title="Note">
  This block height of `21443` represents when the voting contract was deployed. For more details on optional configurations and other predicate elements, check out the [Predicate Design](/stacks/chainhook/concepts/predicate-design) page.
</Callout>
