...
In the [examples for transactions](/stacks/stacks.js/concepts/transactions), we used `AnchorMode.Any` to indicate that the transaction can be "mined" in different ways.
