...
<h2 className='mt-0'>`callReadOnlyFunction`</h2>
...
<Property required={true} deprecated={false} name={"contractAddress"} type={"string"}>

The principal of the contract address you are calling, starts with `SP` for mainnet and `ST` for testnet. 

</Property>

<Property required={true} deprecated={false} name={"contractName"} type={"string"}>

The name of the contract address you are calling, comes after the `.` on the contract address.

</Property>

<Property required={true} deprecated={false} name={"functionName"} type={"string"}>

The name of the `read-only` function you are calling.

</Property>

<Property required={true} deprecated={false} name={"functionArgs"} type={"array"}>
...
<Property required={true} deprecated={false} name={"network"} type={"object"}>

The network instance that the contract exists on.

<span>Example:  `new StacksTestnet()`</span>

</Property>

<Property required={true} deprecated={false} name={"senderAddress"} type={"string"}>

The principal address that the call is being made from.

</Property>

<Property required={false} deprecated={false} name={"postConditions"} type={"array"}>
...
<Tabs defaultValue="read-only">
  <TabsList className='flex flex-wrap'>
    <TabsTrigger value="read-only" className='tab group'>
    ...
    <TabsTrigger value="call-public" className='tab group'>
