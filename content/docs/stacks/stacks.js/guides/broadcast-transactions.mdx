...
description: This guide explains how to create and broadcast transactions to the Stacks blockchain network using Stacks.js packages.
---
  ...
  <Step>
    <div className="flex flex-col">
      <div className="w-full">
        <p className='text-lg font-bold m-0'>Install dependencies</p>
        <p>These are the three main packages we'll use to authenticate users and build our transactions for broadcasting to the Stacks blockchain network.</p>
      </div>
      <div className="w-full">
        ```package-install
