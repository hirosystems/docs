...
<div className='steps space-y-10'>
  <Step>
    <div className="flex flex-col">
      <div className="w-full">
        <p className='text-xl font-bold m-0'>Install <code className='text-lg'>@stacks/connect</code></p>
  ...
  <Step>
    <div className="flex flex-col">
      <div className="w-full">
        <p className='text-xl font-bold m-0'>Initiate a <code className='text-lg'>userSession</code> with specific permission scopes</p>
  ...
  <Step>
    <div className="flex flex-col">
      <div className="w-full">
        <p className='text-xl font-bold m-0'>Trigger the authentication flow with the <code className='text-lg'>showConnect</code> function</p>
  ...
  <Step>
    <div className="flex flex-col">
      <div className="w-full">
        <p className='text-xl font-bold m-0'>Handle Pending Authentication</p>
