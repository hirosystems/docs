...
<Callout title="Note" type="info">
  ...
  the older set of endpoints. Though they continue to function alongside v2, be
  advised that they will be deprecated in the coming months.
</Callout>
...
The ﻿/extended/v2/_ endpoints represent the modern API that is being continually expanded to support the Nakamoto upgrade. We encourage developers to use v2 endpoints for new developments. Be aware that ﻿/extended/v1/_ are the older set of endpoints. Though they continue to function alongside v2, be advised that they will be deprecated in the coming months.
...
View the [API Reference](/stacks/api) here.
