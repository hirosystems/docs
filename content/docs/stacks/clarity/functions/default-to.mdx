---
title: default-to
description: Providing a default value for optional types in Clarity smart contracts.
---
...
(define-read-only (get-user-profile (user principal))
  (let ((profile (default-to { name: "", age: u0 } (map-get? user-profiles user))))
    {
...
;; Usage
(map-set user-profiles tx-sender { name: "Alice", age: u30 })
(get-user-profile tx-sender) ;; Returns { name: "Alice", age: u30 }
(get-user-profile 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM) ;; Returns { name: "Anonymous", age: u0 }
```
