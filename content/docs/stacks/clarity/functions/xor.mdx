...
(define-public (decrypt (encrypted-data int) (key int))
  (ok (xor encrypted-data key))
)

;; Usage
(encrypt 42 123) ;; Encrypts 42 with key 123
(decrypt 165 123) ;; Decrypts 165 with key 123, returns 42
```
