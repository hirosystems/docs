...
description: Converting a byte buffer to an unsigned integer using little-endian encoding in Clarity smart contracts.
---
...
## Practical example: Decode an unsigned integer from external data
