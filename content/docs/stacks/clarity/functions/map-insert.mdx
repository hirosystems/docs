...
(define-public (insert-user-data (user principal) (data (buff 32)))
  (map-insert userData { userId: user } { data: data })
)

;; Usage
(insert-user-data tx-sender 0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef) ;; Returns true if the entry is inserted
(insert-user-data tx-sender 0xabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdef) ;; Returns false if the entry already exists
```
