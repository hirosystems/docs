---
title: map-set
description: Setting an entry in a map in Clarity smart contracts.
---
...
(define-public (set-user-data (user principal) (data (buff 32)))
  (map-set userData { userId: user } { data: data })
)

;; Usage
(set-user-data tx-sender 0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef) ;; Returns true
(set-user-data tx-sender 0xabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdef) ;; Returns true
```
