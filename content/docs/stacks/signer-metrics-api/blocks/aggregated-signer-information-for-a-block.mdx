...
<APIInfo method={"GET"} route={"/signer-metrics/v1/blocks/{height_or_hash}"}>
...
<Property name={"height_or_hash"} type={"Any properties in string, Block hash, Block height"} required={true} deprecated={false}>
...
<APIPlayground authorization={undefined} method={"GET"} route={"/signer-metrics/v1/blocks/{height_or_hash}"} path={[{"name":"height_or_hash","type":"switcher","items":{"string":{"type":"ref","isRequired":true,"schema":"0"},"Block hash":{"type":"ref","isRequired":true,"schema":"1"},"Block height":{"type":"ref","isRequired":true,"schema":"2"}},"isRequired":true}]} query={[]} header={[]} body={undefined} schemas={{"0":{"type":"string","defaultValue":"","isRequired":false},"1":{"type":"string","defaultValue":"","isRequired":false,"description":"Block hash"},"2":{"type":"number","defaultValue":"","isRequired":false,"description":"Block height"}}}>
