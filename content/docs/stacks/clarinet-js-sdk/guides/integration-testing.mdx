...
describe("stx-defi", () => {
  it('borrows 10 and verifies the amount owed to be 10', () => {
    ...
    simnet.callPublicFn('stx-defi', 'borrow', [Cl.uint(10)], wallet1);
...
1. Ensures that our contract returned a successful Clarity response type
2. The value returned is a Clarity unsigned integer with the exact value we expect (`10`).
