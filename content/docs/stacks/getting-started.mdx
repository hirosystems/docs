...
<Cards className='sm:grid-cols-3'>
  ...
  <Card
    ...
    title="Simulate a blockchain with the Clarinet SDK"
...
<Cards className='sm:grid-cols-3'>
  ...
  <Card
    ...
    description="Dive into a step-by-step guide on building a no-loss lottery pool that leverages stacking yield."
  />
  <Card
