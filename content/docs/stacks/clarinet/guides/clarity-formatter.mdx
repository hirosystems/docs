...
description: Learn how to use the Clarity formatter to standardize your smart contract code style.
---
...
2.  **Clarinet CLI**: Enables formatting via the command line, including formatting entire projects.
