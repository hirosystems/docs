...
In this quickstart guide, you will be initializing a simulated development network for testing a smart contract using the Clarinet SDK. Throughout this tutorial, you'll learn how to initialize your project, interact with a smart contract, call its functions and test the results.
