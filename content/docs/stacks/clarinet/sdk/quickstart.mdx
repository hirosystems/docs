...
Check out the [methods](/stacks/clarinet/sdk/references/methods) page for the Clarinet SDK to learn about the different ways that you can interact with simnet.
