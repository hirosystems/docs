...
Users must authenticate to an app before you request message signing. Users can install an authenticator like the [Leather Wallet](https://leather.io/install-desktop).
...
Now you can verify the signature using the `@stacks/encryption` package.
