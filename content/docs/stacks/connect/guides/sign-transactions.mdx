...
description: Prompt users to sign transactions and broadcast them to the Stacks blockchain using Stacks.js.
---
...
Users must authenticate to an app before prompting them to sign and broadcast transactions to the Stacks blockchain with an authenticator such as the [Stacks Wallet](https://leather.io/install-desktop).
