...
You can use the default Search Dialog from [Fumadocs UI](/bitcoin/search).
...
Flexsearch. You can extract the structured data using the [Structure](/stacks/mdx/structure) remark plugin.
