...
<APIInfo method={"GET"} route={"/extended/v1/tx"}>
...
<span>Example: `"coinbase"`</span>

</Property>

<Property name={"from_address"} type={"string"} required={false} deprecated={false}>

Option to filter results by sender address

</Property>

<Property name={"to_address"} type={"string"} required={false} deprecated={false}>

Option to filter results by recipient address

</Property>

<Property name={"sort_by"} type={"string"} required={false} deprecated={false}>

Option to sort results by block height, timestamp, or fee

<span>Example: `"burn_block_time"`</span>

<span>Default: `"block_height"`</span>

<span>Value in: `"block_height" | "burn_block_time" | "fee"`</span>

</Property>

<Property name={"start_time"} type={"integer"} required={false} deprecated={false}>

Filter by transactions after this timestamp (unix timestamp in seconds)

<span>Example: `1704067200`</span>

</Property>

<Property name={"end_time"} type={"integer"} required={false} deprecated={false}>

Filter by transactions before this timestamp (unix timestamp in seconds)

<span>Example: `1706745599`</span>

</Property>

<Property name={"contract_id"} type={"string"} required={false} deprecated={false}>

Filter by contract call transactions involving this contract ID

<span>Example: `"SP000000000000000000002Q6VF78.pox-4"`</span>

</Property>

<Property name={"function_name"} type={"string"} required={false} deprecated={false}>

Filter by contract call transactions involving this function name

<span>Example: `"delegate-stx"`</span>

</Property>

<Property name={"nonce"} type={"integer"} required={false} deprecated={false}>
...
<APIPlayground authorization={undefined} method={"GET"} route={"/extended/v1/tx"} path={[]} query={[{"name":"limit","type":"number","defaultValue":100,"isRequired":false},{"name":"offset","type":"number","defaultValue":42000,"isRequired":false},{"name":"type","type":"array","isRequired":false,"items":"0"},{"name":"from_address","type":"string","defaultValue":"","isRequired":false},{"name":"to_address","type":"string","defaultValue":"","isRequired":false},{"name":"sort_by","type":"string","defaultValue":"burn_block_time","isRequired":false},{"name":"start_time","type":"number","defaultValue":1704067200,"isRequired":false},{"name":"end_time","type":"number","defaultValue":1706745599,"isRequired":false},{"name":"contract_id","type":"string","defaultValue":"SP000000000000000000002Q6VF78.pox-4","isRequired":false},{"name":"function_name","type":"string","defaultValue":"delegate-stx","isRequired":false},{"name":"nonce","type":"number","defaultValue":123,"isRequired":false},{"name":"order","type":"string","defaultValue":"desc","isRequired":false},{"name":"unanchored","type":"boolean","defaultValue":true,"isRequired":false}]} header={[]} body={undefined} schemas={{"0":{"type":"string","defaultValue":"","isRequired":false}}}>
...
```bash
curl -X GET "https://api.mainnet.hiro.so/extended/v1/tx?limit=100&offset=42000&type=coinbase&from_address=string&to_address=string&sort_by=burn_block_time&start_time=1704067200&end_time=1706745599&contract_id=SP000000000000000000002Q6VF78.pox-4&function_name=delegate-stx&nonce=123&order=desc&unanchored=true"
```
...
```js
fetch("https://api.mainnet.hiro.so/extended/v1/tx?limit=100&offset=42000&type=coinbase&from_address=string&to_address=string&sort_by=burn_block_time&start_time=1704067200&end_time=1706745599&contract_id=SP000000000000000000002Q6VF78.pox-4&function_name=delegate-stx&nonce=123&order=desc&unanchored=true", {
  method: "GET"
});
```
