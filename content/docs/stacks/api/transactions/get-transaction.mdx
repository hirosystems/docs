...
<APIInfo method={"GET"} route={"/extended/v1/tx/{tx_id}"}>
...
<span>Example: `"0xe0cc8444f6303fabef13e1fea00fcddb3db6b9519ce808f3f812fafec42fae5b"`</span>
...
<APIPlayground authorization={undefined} method={"GET"} route={"/extended/v1/tx/{tx_id}"} path={[{"name":"tx_id","type":"string","defaultValue":"0xe0cc8444f6303fabef13e1fea00fcddb3db6b9519ce808f3f812fafec42fae5b","isRequired":true}]} query={[]} header={[]} body={undefined} schemas={{}}>
...
```js
fetch("https://api.mainnet.hiro.so/extended/v1/tx/%7Btx_id%7D", {
  method: "GET"
});
```
