...
<APIInfo method={"GET"} route={"/extended/v2/addresses/{address}/transactions"}>
...
```bash
curl -X GET "https://api.mainnet.hiro.so/extended/v2/addresses/SP31DA6FTSJX2WGTZ69SFY11BH51NZMB0ZW97B5P0/transactions?limit=20&offset=10"
```
...
```js
fetch("https://api.mainnet.hiro.so/extended/v2/addresses/SP31DA6FTSJX2WGTZ69SFY11BH51NZMB0ZW97B5P0/transactions?limit=20&offset=10", {
  method: "GET"
});
```
