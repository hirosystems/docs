...
<h2 className="not-prose mb-2 inline-flex items-center gap-3 font-mono">
  ...
  <p className="text-xs">{`/extended/v1/address/{principal}/transactions_with_transfers`}</p>
</h2>
...
```bash title="curl"
curl -X GET "https://api.mainnet.hiro.so/extended/v1/address/SP31DA6FTSJX2WGTZ69SFY11BH51NZMB0ZW97B5P0/transactions_with_transfers"
```
