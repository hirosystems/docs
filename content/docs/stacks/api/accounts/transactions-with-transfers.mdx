...
```js
fetch("https://api.hiro.so/extended/v1/address/SP31DA6FTSJX2WGTZ69SFY11BH51NZMB0ZW97B5P0/transactions_with_transfers?limit=20&offset=10&height=66119&unanchored=true&until_block=60000", {
  method: "GET"
});
```
