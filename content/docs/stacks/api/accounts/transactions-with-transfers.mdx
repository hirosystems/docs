...
```bash
curl -X GET "https://api.hiro.so/extended/v1/address/SP318Q55DEKHRXJK696033DQN5C54D9K2EE6DHRWP/transactions_with_transfers?limit=20&offset=0&height=0&unanchored=false&until_block=string"
```
...
```js
fetch("https://api.hiro.so/extended/v1/address/SP318Q55DEKHRXJK696033DQN5C54D9K2EE6DHRWP/transactions_with_transfers?limit=20&offset=0&height=0&unanchored=false&until_block=string", {
  method: "GET"
});
```
