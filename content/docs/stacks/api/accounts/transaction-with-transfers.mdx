...
```js
fetch("https://api.hiro.so/extended/v1/address/SP3FBR2AGK5H9QBDH3EEN6DF8EK8JY7RX8QJ5SVTE/0x34d79c7cfc2fe525438736733e501a4bf0308a5556e3e080d1e2c0858aad7448/with_transfers", {
  method: "GET"
});
```
