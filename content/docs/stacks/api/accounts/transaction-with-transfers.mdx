...
This endpoint is deprecated in favor of [Get events for an address transaction](/stacks/api/transactions/events-for-an-address-transaction).
</Callout>
...
<span>Example: `"SP3FBR2AGK5H9QBDH3EEN6DF8EK8JY7RX8QJ5SVTE"`</span>
...
<span>Example: `"0x34d79c7cfc2fe525438736733e501a4bf0308a5556e3e080d1e2c0858aad7448"`</span>
...
<APIPlayground authorization={undefined} method={"GET"} route={"/extended/v1/address/{principal}/{tx_id}/with_transfers"} path={[{"name":"principal","type":"string","defaultValue":"SP3FBR2AGK5H9QBDH3EEN6DF8EK8JY7RX8QJ5SVTE","isRequired":true},{"name":"tx_id","type":"string","defaultValue":"0x34d79c7cfc2fe525438736733e501a4bf0308a5556e3e080d1e2c0858aad7448","isRequired":true}]} query={[]} header={[]} body={undefined} schemas={{}}>
...
```bash
curl -X GET "https://api.mainnet.hiro.so/extended/v1/address/SP3FBR2AGK5H9QBDH3EEN6DF8EK8JY7RX8QJ5SVTE/0x34d79c7cfc2fe525438736733e501a4bf0308a5556e3e080d1e2c0858aad7448/with_transfers"
```
...
```js
fetch("https://api.mainnet.hiro.so/extended/v1/address/SP3FBR2AGK5H9QBDH3EEN6DF8EK8JY7RX8QJ5SVTE/0x34d79c7cfc2fe525438736733e501a4bf0308a5556e3e080d1e2c0858aad7448/with_transfers", {
  method: "GET"
});
```
