...
```bash
curl -X GET "https://api.mainnet.hiro.so/extended/v1/address/SP31DA6FTSJX2WGTZ69SFY11BH51NZMB0ZW97B5P0/stx_inbound?limit=0&offset=42000&height=0&unanchored=true&until_block=60000"
```
...
```js
fetch("https://api.mainnet.hiro.so/extended/v1/address/SP31DA6FTSJX2WGTZ69SFY11BH51NZMB0ZW97B5P0/stx_inbound?limit=0&offset=42000&height=0&unanchored=true&until_block=60000", {
  method: "GET"
});
```
