...
<span>Example: `"SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.marketplace-v3"`</span>

</Property>

<Property name={"asset_identifiers"} type={"array<string>"} required={false} deprecated={false}>

identifiers of the token asset classes to filter for

<span>Example: `"SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy::candy"`</span>
...
<APIPlayground authorization={undefined} method={"GET"} route={"/extended/v1/tokens/nft/holdings"} path={[]} query={[{"name":"principal","type":"string","defaultValue":"SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.marketplace-v3","isRequired":true},{"name":"asset_identifiers","type":"array","isRequired":false,"items":"0"},{"name":"limit","type":"number","defaultValue":"","isRequired":false},{"name":"offset","type":"number","defaultValue":42000,"isRequired":false},{"name":"unanchored","type":"boolean","defaultValue":true,"isRequired":false},{"name":"tx_metadata","type":"boolean","defaultValue":"","isRequired":false}]} header={[]} body={undefined} schemas={{"0":{"type":"string","defaultValue":"","isRequired":false}}}>
...
```bash
curl -X GET "https://api.mainnet.hiro.so/extended/v1/tokens/nft/holdings?principal=SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.marketplace-v3&asset_identifiers=SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy%3A%3Acandy&limit=50&offset=42000&unanchored=true&tx_metadata=false"
```
...
```js
fetch("https://api.mainnet.hiro.so/extended/v1/tokens/nft/holdings?principal=SPNWZ5V2TPWGQGVDR6T7B6RQ4XMGZ4PXTEE0VQ0S.marketplace-v3&asset_identifiers=SPQZF23W7SEYBFG5JQ496NMY0G7379SRYEDREMSV.Candy%3A%3Acandy&limit=50&offset=42000&unanchored=true&tx_metadata=false", {
  method: "GET"
});
```
