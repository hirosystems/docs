...
```bash
curl -X GET "https://api.mainnet.hiro.so/extended/v1/burnchain/rewards/36hQtSEXBMevo5chpxhfAGiCTSC34QKgda?limit=0&offset=42000"
```
...
```js
fetch("https://api.mainnet.hiro.so/extended/v1/burnchain/rewards/36hQtSEXBMevo5chpxhfAGiCTSC34QKgda?limit=0&offset=42000", {
  method: "GET"
});
```
