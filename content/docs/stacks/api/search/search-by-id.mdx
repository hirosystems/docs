...
<APIInfo method={"GET"} route={"/extended/v1/search/{id}"}>
...
<Property name={"include_metadata"} type={"boolean"} required={false} deprecated={false}>
...
<APIPlayground authorization={undefined} method={"GET"} route={"/extended/v1/search/{id}"} path={[{"name":"id","type":"string","defaultValue":"0xcf8b233f19f6c07d2dc1963302d2436efd36e9afac127bf6582824a13961c06d","isRequired":true}]} query={[{"name":"include_metadata","type":"boolean","defaultValue":"","isRequired":false}]} header={[]} body={undefined} schemas={{}}>
...
```bash
curl -X GET "https://api.mainnet.hiro.so/extended/v1/search/0xcf8b233f19f6c07d2dc1963302d2436efd36e9afac127bf6582824a13961c06d?include_metadata=true"
```
...
```js
fetch("https://api.mainnet.hiro.so/extended/v1/search/0xcf8b233f19f6c07d2dc1963302d2436efd36e9afac127bf6582824a13961c06d?include_metadata=true", {
  method: "GET"
});
```
