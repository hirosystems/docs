...
<Callout>
Read more about post-conditions [here](/stacks/stacks.js/concepts/post-conditions).
</Callout>
...
| Literal                                           | `1000000`                                   | Use a number or true/false value to check if the asset meets the condition        |
...
The easiest way to construct well-formed transactions is by [using the Stacks.js Transactions library](/stacks/stacks.js/packages/transactions). With that library, you can construct the following transaction types:
...
Serialized, raw transactions can be deserialized without access to the internet using [the Stacks.js Transactions library](/stacks/stacks.js/packages/transactions):
