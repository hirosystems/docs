...
For detailed VS Code features, see the [extension guide](/tools/clarinet/integrations/vscode-extension).

## Related guides

- [Create your first project](/tools/clarinet/quickstart)
- [VS Code extension features](/tools/clarinet/integrations/vscode-extension)
- [Clarinet configuration](/tools/clarinet/clarinet-toml)