...
Perfect! Your wallet is ready for development. 

[Create your first Clarinet project](/docs/smart-contracts/creating-clarinet-project) to start building smart contracts. You'll use this wallet to deploy and interact with your contracts on the local devnet.

For deeper wallet features like hardware wallet integration, token management, or production network setup, check out [Leather's complete guides](https://leather.io/guides).
