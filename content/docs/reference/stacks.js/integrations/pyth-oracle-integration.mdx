...
<Cards>
  <Card
    ...
    description="Learn how to write oracle-enabled smart contracts"
  />
  <Card
    href="/tools/clarinet/integrations/pyth-oracle-integration"
    title="Testing with Clarinet"
    description="Test your oracle integrations locally"
  />
  <Card
    href="/resources/guides/using-pyth-price-feeds"
    title="Complete guide"
    description="See the full end-to-end implementation"
  />
</Cards>