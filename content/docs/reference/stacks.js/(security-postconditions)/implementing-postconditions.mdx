...
<Cards>
  <Card
    href="/reference/stacks.js/security-postconditions/security-best-practices"
    title="Security best practices"
    description="Learn security patterns for Stacks apps"
  />
  <Card
  ...
  <Card
    ...
    description="Apply post-conditions to contract calls"
  />
</Cards>