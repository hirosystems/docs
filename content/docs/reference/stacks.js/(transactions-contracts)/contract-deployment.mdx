...
:::next-steps
- [Transaction types](/reference/stacks.js/transactions-contracts/transaction-types): Explore all transaction types available
- [Contract encoding](/reference/stacks.js/common-utilities/encoding-decoding): Work with contract data encoding
:::