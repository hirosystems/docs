...
:::next-steps
- [Post-conditions](/reference/stacks.js/security-postconditions/understanding-postconditions): Add security constraints to any transaction
- [Clarity encoding](/reference/stacks.js/common-utilities/encoding-decoding): Encode arguments for transactions
:::