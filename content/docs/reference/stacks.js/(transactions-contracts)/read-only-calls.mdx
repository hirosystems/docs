...
<Cards>
  <Card
    ...
    description="Execute state-changing contract functions"
  />
  <Card
    href="/reference/stacks.js/common-utilities/encoding-decoding"
    title="Clarity encoding"
    description="Work with Clarity values and types"
  />
  <Card
    href="/reference/stacks.js/transactions-contracts/contract-deployment"
    title="Deploy contracts"
    description="Deploy smart contracts to the network"
  />
</Cards>