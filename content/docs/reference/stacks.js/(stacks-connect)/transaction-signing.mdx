...
:::next-steps
- [Message signing](/reference/stacks.js/wallet-connection/message-signing): Sign and verify arbitrary messages
- [Post-conditions guide](/reference/stacks.js/security-postconditions/implementing-postconditions): Implement transaction security constraints
:::