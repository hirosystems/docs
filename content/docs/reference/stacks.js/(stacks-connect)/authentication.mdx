...
:::next-steps
- [Transaction signing](/reference/stacks.js/wallet-connection/transaction-signing): Request signatures for transactions
- [Message signing](/reference/stacks.js/wallet-connection/message-signing): Sign and verify messages
:::