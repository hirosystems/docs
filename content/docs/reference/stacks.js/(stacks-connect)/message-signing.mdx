...
:::next-steps
- [Network switching](/reference/stacks.js/wallet-connection/network-switching): Handle mainnet/testnet network changes
- [Encryption utilities](/reference/stacks.js/common-utilities/encryption): Encrypt and decrypt data with keys
:::