---
title: Getting started with post-conditions
...
:::callout
type: warn
Using `PostConditionMode.Allow` reduces security by permitting unspecified asset transfers. Only use when explicitly needed.
:::

## Further reading

- [Implementing post-conditions](/reference/stacks.js/(post-conditions)/implementing-post-conditions)
