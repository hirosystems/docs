...
:::next-steps
- [Network switching](/reference/stacks.js/wallet-connection/network-switching): Learn how to switch networks in Stacks.
- [Address validation](/reference/stacks.js/common-utilities/address-validation): Learn how to validate addresses in Stacks.
:::