...
<Cards>
  <Card
    href="/reference/stacks.js/common-utilities/unit-conversion"
    title="Unit conversion"
    description="Convert between STX and microSTX"
  />
  <Card
    href="/reference/stacks.js/common-utilities/encoding-decoding"
    title="Encoding principals"
    description="Encode addresses as Clarity values"
  />
  <Card
    href="/reference/stacks.js/wallet-connection/authentication"
    title="Authentication"
    description="Verify address ownership"
  />
</Cards>