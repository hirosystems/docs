...
:::next-steps
- [Unit conversion](/reference/stacks.js/common-utilities/unit-conversion): Learn how to convert units in Stacks.
- [Encoding principals](/reference/stacks.js/common-utilities/encoding-decoding): Learn how to encode and decode principals in Stacks.
:::