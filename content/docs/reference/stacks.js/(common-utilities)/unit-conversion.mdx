...
<Cards>
  <Card
    ...
    description="Use converted amounts in transactions"
  />
  <Card
    href="/reference/stacks.js/common-utilities/encoding-decoding"
    title="Encode amounts"
    description="Convert amounts to Clarity values"
  />
  <Card
    href="/reference/stacks.js/wallet-connection/transaction-signing"
    title="Transaction signing"
    description="Sign transactions with amounts"
  />
</Cards>