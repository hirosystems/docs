...
<Cards>
  <Card
    ...
    description="Learn about managing user sessions and profile data"
  />
  <Card
    href="/reference/stacks.js/transactions-contracts/transaction-building"
    title="Build custom transactions"
    description="Create contract calls and complex transactions"
  />
  <Card
    href="/reference/stacks.js/security-postconditions/understanding-postconditions"
    title="Add post-conditions"
    description="Implement security checks for your transactions"
  />
</Cards>