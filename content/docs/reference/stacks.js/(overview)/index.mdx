...
<Cards>
  <Card
    ...
    title="Quickstart"
    description="Build your first Stacks app in 5 minutes"
  />
  <Card
    href="/reference/stacks.js/wallet-connection/connect-wallet"
    title="Connect a wallet"
    description="Learn how to integrate wallet connectivity"
  />
  <Card
    href="/reference/stacks.js/transactions-contracts/read-only-calls"
    title="Read contract data"
    description="Call read-only functions to query smart contracts"
  />
</Cards>
