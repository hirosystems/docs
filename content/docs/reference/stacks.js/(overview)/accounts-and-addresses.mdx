...
- [Wallet SDK](/reference/stacks.js/packages/wallet-sdk)
- [Connect wallet](/reference/stacks.js/(connect)/connect-wallet)
- [Authenticate users](/reference/stacks.js/(connect)/authenticate-users)