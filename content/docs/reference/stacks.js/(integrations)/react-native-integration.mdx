...
:::next-steps
- [Transactions package](/reference/stacks.js/packages/transactions): Deep dive into transaction construction and signing
- [Wallet SDK](/reference/stacks.js/packages/wallet-sdk): Advanced wallet management features
:::