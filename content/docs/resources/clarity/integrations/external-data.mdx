...
:::next-steps
- [Frontend integration](/reference/stacks.js/integrations/pyth-oracle-integration): Learn how to fetch VAA messages and call your oracle-enabled contracts
- [Testing with Clarinet](/tools/clarinet/integrations/pyth-oracle-integration): Set up tests for contracts that depend on oracle data
:::