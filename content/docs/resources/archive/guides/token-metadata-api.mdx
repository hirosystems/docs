...
If you don't already have one, you can follow [these instructions](/resources/archive/guides/stacks-blockchain) to launch one with an archive.
...
1. [Verify the archive](/resources/archive/guides/verify-archive-data) with the shasum.
