...
:::next-steps
- [Run Chainhook as a service](/stacks/chainhook/guides/chainhook-as-a-service): Learn how to use Chainhook to build your own custom API.
- [Sync a Bitcoin node](/guides/sync-a-bitcoin-node): Learn how to sync a Bitcoin node for running Chainhook as a service.
:::