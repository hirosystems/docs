...
:::next-steps
- [Authenticate users](/stacks/connect/guides/authenticate-users): Learn how to authenticate users using the Connect package in Stacks.js.
- [Broadcast transactions](/stacks/connect/guides/broadcast-transactions): Learn how to sign and broadcast transactions.
:::