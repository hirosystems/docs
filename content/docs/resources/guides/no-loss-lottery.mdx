...
:::next-steps
- [Create a new project](/stacks/clarinet/guides/create-a-new-project): Learn how to create a new Clarinet project.
- [Deploy a contract](/stacks/clarinet/guides/deploy-a-contract): Learn how to deploy a contract to a Clarinet network.
:::
