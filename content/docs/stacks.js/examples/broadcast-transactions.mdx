...
{/* :::callout
### Example Repo
To see this guide in action, check out a full example [here](https://github.com/hiro-so/stacks-connect-example).
::: */}
...
:::next-steps
- [Deep dive into post-conditions](/stacks/stacks.js/guides/post-conditions): Learn how to use post-conditions to secure your smart contracts.
- [API References](/stacks/stacks.js/packages/transactions): Dive into the API references for Stacks.js.
:::