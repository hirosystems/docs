...
:::next-steps
- [Create chainhooks](/tools/chainhook/create): Create and activate chainhooks
- [Manage consumer secrets](/tools/chainhook/keys): Learn how to validate Chainhook delivery
:::
