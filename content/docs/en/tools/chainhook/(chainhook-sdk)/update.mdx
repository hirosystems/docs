...
description: Modify existing chainhooks including filters, actions, and options
---
...
:::next-steps
- [Get chainhooks](/tools/chainhook/fetch): Retrieve chainhook information before updating
