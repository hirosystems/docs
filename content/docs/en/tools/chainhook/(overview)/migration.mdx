...
:::prerequisites
- Hiro API key for access to both the Platform and Chainhook API.
:::
...
For more details on the format changes, see the [Filters](/tools/chainhook/reference/filters) reference guide.
...
For more details, check out the [Filters](/tools/chainhook/reference/filters) reference page.

## Next steps

:::next-steps
- [FAQ](/tools/chainhook/faq): Chainhook 2.0 FAQ
