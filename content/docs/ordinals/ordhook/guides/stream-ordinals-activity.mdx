...
This section walks you through streaming Ordinals activity. To post that activity, you'll need to configure bitcoind. Refer to [setting up a bitcoin node](./ordhook-as-a-service-bitcoind.md#setting-up-a-bitcoin-node) to understand the steps to configure Bitcoind.
