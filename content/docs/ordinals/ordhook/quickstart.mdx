---
title: Quickstart
description: Learn how to quickly scan for ordinal activity on Bitcoin.
---
...
To follow this quickstart guide, you will need to have Ordhook installed on your machine. If you haven't already, check out the [Installation](/ordinals/ordhook/installation) guide.
