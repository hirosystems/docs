...
- Scan blocks in your terminal. See the [Scanning Ordinal Activities](./guides/scan-ordinal-activities) guide.
- Stream ordinal activity to an external API. Refer to the [Streaming Ordinal Activities](./guides/stream-ordinal-activities) guide.
