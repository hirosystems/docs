...
The output strictly follows [Page Conventions](/stacks/page-conventions). During the process, your input source files will be parsed and form a virtual storage to avoid inconsistent behaviour between different OS.
...
Load the [icon](/stacks/page-conventions#icons) from the data of pages and meta files.
