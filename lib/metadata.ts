...
const defaultMetadata: Metadata = {
  title: 'Hiro Docs',
  description: 'All the developer docs, guides and resources you need to build on Bitcoin layers.',
  openGraph: {
    title: 'Hiro Docs',
    description:
...
const hiroHacksMetadata: Partial<Metadata> = {
  title: 'Hiro Hacks',
  description: 'Join Hiro Hacks and build on Bitcoin layers with our monthly themed challenges.',
  openGraph: {
    title: 'Hiro Hacks',
    description: 'Join Hiro Hacks and build on Bitcoin layers with our monthly themed challenges.',
    images: [
...
const tokenMetadataApiMetadata: Partial<Metadata> = {
  ...
  openGraph: {
    title: 'Token Metadata API',
    description: 'Access and manage token metadata on the Stacks blockchain.',
    images: [{ url: '/images/token-metadata-api-og.jpg', width: 800, height: 600 }],
  },
  twitter: {
    title: 'Token Metadata API',
    description: 'Access and manage token metadata on the Stacks blockchain.',
...
export function getRouteMetadata(path: string): Partial<Metadata> {
  if (path.startsWith('/stacks/api-keys') || path.startsWith('/bitcoin/api-keys')) {
