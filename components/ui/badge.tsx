...
const badgeVariants = cva(
  "inline-flex items-center rounded-lg border px-2 py-1 text-xs font-regular font-aeonik-fono transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 group-data-[state=active]:bg-inverted group-data-[state=active]:text-background",
  {
    variants: {
      variant: {
        default:
