  ...
  plugins: [
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl:
          'https://raw.githubusercontent.com/hirosystems/stacks-blockchain-api/master/content/', // the base url for the markdown (gets prepended to all of the documents when fetching)
        outDir: 'docs/stacks-blockchain-api', // the base directory to output to.
        documents: ['faqs.md', 'getting-started.md', 'overview.md', 'troubleshooting.md'], // the file names to download
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl:
          'https://raw.githubusercontent.com/hirosystems/stacks-blockchain-api/master/content/feature-guides', // the base url for the markdown (gets prepended to all of the documents when fetching)
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl:
          'https://raw.githubusercontent.com/hirosystems/stacks-blockchain-api/master/content/how-to-guides/', // the base url for the markdown (gets prepended to all of the documents when fetching)
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        outDir: 'docs/stacks-blockchain-api/', // the base directory to output to.
        documents: ['images/api-architecture.png'], // the file names to download
        // in the plugin's options:
        //noRuntimeDownloads: "true",
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        documents: ['faq.md', 'getting-started.md', 'overview.md', 'troubleshooting.md'], // the file names to download
        // in the plugin's options:
        // noRuntimeDownloads: "true"
      },
    ],
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl:
          'https://raw.githubusercontent.com/hirosystems/stacks.js/master/docs/includes', // the base url for the markdown (gets prepended to all of the documents when fetching)
        outDir: 'docs/stacks.js/includes/', // the base directory to output to.
        documents: ['stacks.js-starters-note.mdx'], // the file names to download
        // in the plugin's options:
        // noRuntimeDownloads: "true"
      },
    ],
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl:
          'https://raw.githubusercontent.com/hirosystems/stacks.js/master/docs/feature-guides', // the base url for the markdown (gets prepended to all of the documents when fetching)
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl:
          'https://raw.githubusercontent.com/hirosystems/stacks.js/master/docs/how-to-guides/', // the base url for the markdown (gets prepended to all of the documents when fetching)
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        documents: ['faq.md', 'getting-started.md', 'introduction.md', 'troubleshooting.md'], // the file names to download
        // in the plugin's options:
        // noRuntimeDownloads: "true"
      },
    ],
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl:
          'https://raw.githubusercontent.com/hirosystems/clarinet/main/docs/feature-guides', // the base url for the markdown (gets prepended to all of the documents when fetching)
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl:
          'https://raw.githubusercontent.com/hirosystems/clarinet/main/docs/how-to-guides/', // the base url for the markdown (gets prepended to all of the documents when fetching)
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        documents: ['getting-started.md', 'overview.md'], // the file names to download
        // in the plugin's options:
        // noRuntimeDownloads: "true"
      },
    ],
    ...
    [
      'docusaurus-plugin-remote-content',
      {
        ...
        sourceBaseUrl:
          'https://raw.githubusercontent.com/hirosystems/explorer/main/docs/how-to-guides/', // the base url for the markdown (gets prepended to all of the documents when fetching)
        outDir: 'docs/explorer/how-to-guides', // the base directory to output to.
        documents: ['build-explorer.md'], // the file names to download
        // in the plugin's options:
        // noRuntimeDownloads: "true"
      },
    ],
      ...
      /** @type {import('@docusaurus/preset-classic').Options} */
      {
        docs: {
          ...
          editUrl({ docPath }) {
            ...
            return `https://github.com/hirosystems/docs/blob/main/${docPath}`;
          },
          routeBasePath: '/',
