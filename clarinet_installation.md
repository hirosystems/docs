...
please refer to the [Homebrew](https://brew.sh/)page for detailed information on how to install Homebrew.

Once you have Homebrew installed, run the following command in your terminal.
...
You can resolve the security warning by using the following command:
