...
See [Clarinet 2.4.0](https://github.com/hirosystems/clarinet/releases/tag/v2.4.0) and [Clarinet PR-1350](https://github.com/hirosystems/clarinet/pull/1350) for relevant notes + PRs.
...
[Learn more about the new Clarinet updates](/nakamoto/clarinet)
