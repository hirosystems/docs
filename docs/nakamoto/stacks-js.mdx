...
To test using the Nakamoto testnet, you can use the `StacksTestnet` network with a custom URL. The Nakamoto testnet is being hosted at https://api.nakamoto.hiro.so. Use this URL like this:
