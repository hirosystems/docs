...
<head>
  <meta property="og:url" content="https://docs.hiro.so/hacks/build-a-friend-tech-clone" />
  <meta property="og:type" content="website" />
  <meta property="og:title" content="Hiro Hacks | Build a Decentralized Social Network" />
  <meta
    property="og:description"
    content="Learn how to build a decentralized social network on Stacks."
  />
  <meta property="og:image" content='/img/hack1-og.png' />
</head>
...
This Hack walks you through the basics of building a Friend.tech clone. There are also challenges at the end—opportunities to stretch your skills, differentiate your application, and **win prizes**. [Submit your project here!](https://survey.hiro.so/hirohacks)
...
**UI Integration**: Using the provided [starter template](#clone-the-starter-template), integrate your contract using [Stacks.js](../stacks.js/index.mdx). For example, if you were calling the `is-keyholder` function, your code might look something like this:
...
**Message Signature**: To further enhance the security and authenticity of your app, try to implemement a _login_ feature using [Message Signing](../stacks.js/guides/sign-messages.mdx).
