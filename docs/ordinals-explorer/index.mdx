...
<div className="buttons-container">
  <a className="button-cta white" href="https://ordinals.hiro.so" target='_blank'>
    View Ordinals Explorer
  </a>

  <a className="button-cta orange" href="/ordinals-explorer/guides/build-explorer">
    Spin up your own Explorer <span className="ml-1 no-underline">→</span>
  </a>
</div>
