...
**Hiro Hacks** is a series of challenges preparing developers for building on Bitcoin layers. Our initial rollout begins this December on 1st, 8th, and 15th. On those dates, we will introduce a new `Hack` that involves:

- **Guided Discovery**: We will help you navigate our products, building from the basic building blocks to create something awesome.
