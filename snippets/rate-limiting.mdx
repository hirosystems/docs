...
Additionally, six endpoints fall outside of the standard API rate limits and will have a fixed 500 RPM across all tiers. Those endpoints are:

- `/extended/v1/tx/mempool/dropped`
- `/extended/v2/blocks/${blockHash}/transactions`
- `/extended/v2/blocks/average-times`
- `/extended/v1/contract/${contractId}/events`
- `/extended/v1/tokens/nft/holdings?principal=${address}`
- `/extended/v1/address/${address}/stx_inbound`
